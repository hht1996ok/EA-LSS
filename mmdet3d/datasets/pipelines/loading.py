...
class LoadRadarPointsMultiSweeps(object):
    ...
    def __call__(self, results):
        ...
        cur_pos = can_bus_dict[:2]
        ego_angle = can_bus_dict[-2:-1]
        rotation_angle = can_bus_dict[-1:]
        pos_inf = np.concatenate([cur_pos, ego_angle, rotation_angle], axis=0)
        ...
        #points[:, 0:1] -= self.pc_range[0]
        #points[:, 1:2] -= self.pc_range[1]
        #points[:, 2:3] -= self.pc_range[2]
        ...
        results['pos_inf'] = pos_inf.astype(np.float32)
