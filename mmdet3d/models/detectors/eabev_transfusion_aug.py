...
class EABEV_TransFusion_Aug(EABEV_FasterRCNN_Aug):
    ...
    def __init__(self, **kwargs):
        ...
        super(EABEV_TransFusion_Aug, self).__init__(**kwargs)
    ...
    def init_weights(self, pretrained=None):
        ...
        super(EABEV_TransFusion_Aug, self).init_weights(pretrained)
