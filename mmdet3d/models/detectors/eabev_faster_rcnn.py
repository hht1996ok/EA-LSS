...
class EABEV_FasterRCNN(MVXFasterRCNN):
    ...
    def __init__(self, lss=False, lc_fusion=False, camera_stream=False,
        ...
        """
        super(EABEV_FasterRCNN, self).__init__(**kwargs)
    ...
    def extract_feat(self, points, img, img_metas, img_aug_matrix=None, lidar_aug_matrix=None, gt_bboxes_3d=None):
        ...
        if self.lift:
            ...
            shift_list = [[self.step / H, 0.0 / W], [-self.step / H, 0.0 / W], [0.0 / H, self.step / W], [0.0 / H, -self.step / W]]
            ...
            img_bev_feat, img_metas = self.lift_splat_shot_vis(img_feats_view, rots, trans, lidar2img_rt=lidar2img_rt, img_metas=img_metas, depth_lidar=depth)
